<?php 
   ...
   //  echo getBaseUrl();
    ...
    $allAttendanceUrl = getBaseUrl()."attendance/attendance.php";
    ...
    <ul class="nav">
       ...
       <li class="nav-item">
          ...
          <div class="collapse" id="events">
             <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="<?= $addEventsUrl?>">Add Event</a></li>
       ...
       <li class="nav-item">
          ...
          <div class="collapse" id="users">
             <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"><a class="nav-link" href="<?= $addUserUrl?>">Add User</a></li>
       ...
       <li class="nav-item">
          ...
          <div class="collapse" id="charts">
             <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="<?= $allAttendanceUrl?>">Attendance</a></li>
             </ul>
          </div>
       </li>

<?php
    ...
    $event_start_date_time = isset($_POST["event_start_date"])?trim($_POST["event_start_date"]):"";
    echo $event_start_date_time;
    $event_end_date_time = isset($_POST["event_end_date"])?trim($_POST["event_end_date"]):"";
    ...
    if(!$conn->query($checkUserQuery)->num_rows){
        ...
        $createEventQuery = "INSERT INTO `events` (`event_id`, `name`, `description`, `venue`, `category`, `organized_by`, `start_date_time`, `end_date_time`,  `registration_starting_date_time`, `registration_closing_date_time`, `entry_fee`, `maximum_slot`, `created_by`) VALUES ('$eventId', '$eventName', '$description', '$venue', '$category','$organized_by', '$event_start_date_time', '$event_end_date_time', '$event_Reg_start_date', '$event_Reg_end_date', '$entryFee', '$maxSlot', '$createdBy');";
        

        // $createEventQuery =  "INSERT INTO `events` (`id`, `event_id`, `name`, `description`, `venue`, `category`, `organized_by`, `image`, `start_date_time`, `end_date_time`, `registration_starting_date_time`, `registration_closing_date_time`, `entry_fee`, `maximum_slot`, `created_at`, `created_by`, `updated_at`, `status`) VALUES (NULL, 'Event', 'Event Management System', 'Hello There', 'home', 'test software', 'sanjay', NULL, '2022-10-02 10:10:54', '2022-10-02 10:48:54', '2022-10-02 09:55:54', '2022-10-02 10:09:54', '0', '10', current_timestamp(), '2', NULL, 'live');";
        ...
        $updateQuery = "UPDATE `events` SET 
            ...
            `start_date_time` = '$event_start_date_time',
            `end_date_time` = '$event_end_date_time',
